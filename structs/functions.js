...
// const bcrypt = require("bcrypt"); // Removido - n�o � necess�rio
const fs = require("fs");
...
function getContentPages(req) {
    ...
    const modes = ["battleRoyale"];
    const news = ["battleroyalenews"];
    ...
    try {
        if (memory.build < 5.30) {
            news.forEach(mode => {
                contentpages[mode].news.messages[0].image = "https://cdn.discordapp.com/attachments/1396695834346651770/1401472762358403142/Novo_Projeto.jpg?ex=68a62778&is=68a4d5f8&hm=18c8e1dcec16955b93f322fdfdcb9a0f57f16161e56fc35ca2972cd144709828&";
                contentpages[mode].news.messages[1].image = "https://cdn.discordapp.com/attachments/1396695834346651770/1401472762358403142/Novo_Projeto.jpg?ex=68a62778&is=68a4d5f8&hm=18c8e1dcec16955b93f322fdfdcb9a0f57f16161e56fc35ca2972cd144709828&g";
            });
        }
    } catch { }
    ...
    try {
        ...
        if (memory.build == 19.01) {
            ...
            contentpages.dynamicbackgrounds.backgrounds.backgrounds[0].backgroundimage = "https://cdn.discordapp.com/attachments/1396695834346651770/1401472762358403142/Novo_Projeto.jpg?ex=68a62778&is=68a4d5f8&hm=18c8e1dcec16955b93f322fdfdcb9a0f57f16161e56fc35ca2972cd144709828&";
...
async function registerUser(discordId, username, email, plainPassword) {
    ...
    // Password em texto simples - SEM bcrypt hash
    ...
    try {
        await User.create({
            ...
            email,
            password: passwordToStore, // Guarda password em texto simples
            matchmakingId
        }).then(async (i) => {
